...
namespace Dozing {
    internal static class DozingMap {
        ...
        private const float MapWideBloonSpeed = 1;
        ...
        private static Il2CppReferenceArray<AreaModel> AreaModels => new(6) {
            [0] = AreaWhole,
            [1] = AreaTopTrack,
            [2] = AreaBottomTrack,
            [3] = AreaLampost1,
        ...
        private static Il2CppReferenceArray<BlockerModel> BlockerModels => new(0);

        #endregion

        #region Coop Areas

        private static Il2CppReferenceArray<CoopAreaLayoutModel> CoopAreaLayoutModels => new(1) {
            [0] = CoopAreaLayoutFFA
        };
        ...
        private static Il2CppReferenceArray<PathModel> PathModels => new(2) {
            [0] = TopPath,
            [1] = BottomPath
        };
        ...
        private static Il2CppReferenceArray<RemoveableModel> RemoveableModels => new(0);

        #endregion

        #region Gizmos

        private static Il2CppReferenceArray<MapGizmoModel> MapGizmoModels => new(0);

        #endregion

        #region Path Spawners

        private static PathSpawnerModel PathSpawnerModel => new("", SplitterModel, SplitterModel);
        ...
        private static Il2CppReferenceArray<MapEventModel> MapEventModels => new(0);
